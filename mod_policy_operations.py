...
def add_rule(cb, parser, args, rulepack):
    ...
    # TODO Automatically identify content type based on directory tree
...
def add_rule_yaml(cb, parser, args):
    policies = get_policy_by_name_or_id(cb, args.id, args.name)
...
def main():
    ...
    if args.command_name == "list":
        ...
        return add_rule(cb, parser, args, rulepack)
